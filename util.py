...
def get_random_song_slice(data, sequence_length):
    """
    Retrieves a random slice of the given data with the specified sequence length.
    ...
    """
    # Get a random slice of the given data with the specified sequence length
    if len(data) < sequence_length:
        raise ValueError("Sequence length is greater than the length of the data")
    start_idx = random.randint(0, len(data) - sequence_length)
